...
class YOLOXHead(nn.Module):
    ...
    def forward(self, xin, labels=None, imgs=None):
        ...
        if self.training:  # outputs 已经还原成原图尺寸了，算loss跟所在特征层无关，只与IOU、obj大小有关，故可以直接cat
    ...
    def get_losses(
        ...
        bbox_preds = outputs[:, :, :4]  # [batch, n_anchors_all, 4]  # 已经还原成同一尺寸了
        ...
        for batch_idx in range(outputs.shape[0]):
            ...
            if num_gt == 0:
                ...
                bboxes_preds_per_image = bbox_preds[batch_idx]  # 第idx张图像的预测结果
